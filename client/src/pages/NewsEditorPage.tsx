...
import { ArrowLeft, Save, Image, Trash, Bold, Italic, Underline, List, AlignLeft, AlignCenter, AlignRight } from "lucide-react";
...
// Adicionar declarações de tipo para o Slate
...
// Importar tipos adicionais do React e History do Slate
import { ReactEditor } from 'slate-react';
import { HistoryEditor } from 'slate-history';
import { BaseEditor, BaseElement, BaseText } from 'slate';

// Define os tipos para o Slate editor
type CustomElement = {
...
// Componente do Editor Slate
const SlateEditor = ({ value, onChange }: { value: any, onChange: (value: any) => void }) => {
  const [editor] = useState(() => withHistory(withReact(createEditor())));
  
  // Use try/catch para manejar valores JSON inválidos
  ...
  // Renderiza elementos (parágrafos, cabeçalhos, listas)
  ...
  // Renderiza formatações (negrito, itálico, sublinhado)
