...
import { PlusIcon, FileTextIcon, CalendarIcon, UserIcon } from "lucide-react";
...
export default function ToolProjectsPage() {
  const { user } = useAuth();
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-600">
            Registre e gerencie aulas, visitas técnicas e eventos com inteligência artificial
          </p>
        </div>
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>
                Crie um novo projeto para registrar aulas, visitas técnicas ou eventos
              </DialogDescription>
            </DialogHeader>
            <ToolProjectForm 
              onSuccess={() => {
          ...
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-gray-500 text-center mb-4">
              {selectedType === 'all' 
                ...
                : `Não há projetos do tipo "${typeLabels[selectedType as keyof typeof typeLabels]}" ainda.`
              }
            </p>
            ...
            <Card key={project.id} className="hover:shadow-md transition-shadow">
              ...
              <CardContent>
                ...
                <div className="flex gap-2">
                  <Link href={`/ferramentas/${project.id}`} className="flex-1">
