...
import type { ToolProject, ToolProjectWithCreator } from "./ToolProjectsPage";
...
export default function ToolProjectDetailPage() {
  const { id } = useParams();
  const { user } = useAuth();
                  ...
                  <Dialog open={isReportDialogOpen} onOpenChange={setIsReportDialogOpen}>
                    ...
                    <DialogContent className="max-w-2xl">
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Crie um novo relatório para este projeto
                        </DialogDescription>
                      </DialogHeader>
