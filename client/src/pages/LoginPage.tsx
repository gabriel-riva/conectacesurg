      ...
      <div className="w-full max-w-md z-10 relative">
        <Card className="border-0 shadow-2xl backdrop-blur-sm bg-white/90 overflow-hidden">
          ...
          <CardContent className="pt-8 pb-6 px-8 flex flex-col items-center">
            ...
            <Button
              variant="outline"
              className="flex items-center justify-center gap-4 bg-white border border-gray-300 rounded-lg py-5 px-8 text-gray-700 hover:bg-gray-50 hover:text-gray-900 transition-all duration-200 mx-auto shadow-sm w-3/4"
            ...
            >
              ...
              <span className="font-medium text-lg">{isLoading ? "Carregando..." : "Entrar com Google"}</span>
            </Button>
