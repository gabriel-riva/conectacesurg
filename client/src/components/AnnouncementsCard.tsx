...
export function AnnouncementsCard() {
  ...
  return (
    <Card className="h-[400px] flex flex-col shadow-md hover:shadow-lg transition-shadow duration-300 border-none overflow-hidden">
      ...
      <CardContent className="p-4 flex flex-col" style={{ height: "calc(400px - 54px)" }}>
